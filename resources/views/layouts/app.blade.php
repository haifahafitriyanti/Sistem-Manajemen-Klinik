        ...
        <div class="flex min-h-screen" x-data="{ sidebarCollapsed: false }">
            ...
            <aside :class="sidebarCollapsed ? 'w-20' : 'w-64'" class="bg-slate-900 text-slate-300 fixed inset-y-0 left-0 flex flex-col border-r border-slate-800 z-30 transition-all duration-300">
                ...
                <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto overflow-x-hidden">
                    ...
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-3 py-2.5 rounded-lg text-sm font-medium transition-colors {{ request()->routeIs('dashboard') ? 'bg-[#2C5EAD] text-white shadow-md shadow-[#2C5EAD]/20' : 'hover:bg-slate-800 hover:text-white' }}" :class="sidebarCollapsed ? 'justify-center px-0' : 'px-4'">
                    ...
                    <a href="/doctors" class="flex items-center gap-3 py-2.5 rounded-lg text-sm font-medium transition-colors {{ request()->is('doctors*') ? 'bg-[#2C5EAD] text-white shadow-md shadow-[#2C5EAD]/20' : 'hover:bg-slate-800 hover:text-white' }}" :class="sidebarCollapsed ? 'justify-center px-0' : 'px-4'">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="/appointments" class="flex items-center gap-3 py-2.5 rounded-lg text-sm font-medium transition-colors {{ request()->is('appointments*') ? 'bg-[#2C5EAD] text-white shadow-md shadow-[#2C5EAD]/20' : 'hover:bg-slate-800 hover:text-white' }}" :class="sidebarCollapsed ? 'justify-center px-0' : 'px-4'">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="{{ route('patients.search') }}" class="flex items-center gap-3 py-2.5 rounded-lg text-sm font-medium transition-colors {{ request()->routeIs('patients.*') ? 'bg-[#2C5EAD] text-white shadow-md shadow-[#2C5EAD]/20' : 'hover:bg-slate-800 hover:text-white' }}" :class="sidebarCollapsed ? 'justify-center px-0' : 'px-4'">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="{{ route('pos.index') }}" class="flex items-center gap-3 py-2.5 rounded-lg text-sm font-medium transition-colors {{ request()->routeIs('pos.*') ? 'bg-[#2C5EAD] text-white shadow-md shadow-[#2C5EAD]/20' : 'hover:bg-slate-800 hover:text-white' }}" :class="sidebarCollapsed ? 'justify-center px-0' : 'px-4'">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    @if(auth()->user()->isAdmin())
                    <a href="/users" class="flex items-center gap-3 py-2.5 rounded-lg text-sm font-medium transition-colors {{ request()->is('users*') ? 'bg-[#2C5EAD] text-white shadow-md shadow-[#2C5EAD]/20' : 'hover:bg-slate-800 hover:text-white' }}" :class="sidebarCollapsed ? 'justify-center px-0' : 'px-4'">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- Laporan (Admin) -->
                    <a href="{{ route('reports.index') }}" class="flex items-center gap-3 py-2.5 rounded-lg text-sm font-medium transition-colors {{ request()->routeIs('reports.*') ? 'bg-[#2C5EAD] text-white shadow-md shadow-[#2C5EAD]/20' : 'hover:bg-slate-800 hover:text-white' }}" :class="sidebarCollapsed ? 'justify-center px-0' : 'px-4'">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
